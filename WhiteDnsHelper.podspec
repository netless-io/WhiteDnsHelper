#
# Be sure to run `pod lib lint WhiteDnsHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WhiteDnsHelper'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WhiteDnsHelper.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'WhiteDnsHelper/Classes/**/*'
  
  # s.resource_bundles = {
  #   'WhiteDnsHelper' => ['WhiteDnsHelper/Assets/*.png']
  # }
